...
namespace Junction
{
    ...
    /// </summary>
    public class NewGeneticOptimizer
    {
        ...
        double _delayRate;
        //double _delayVar;
        public NewGeneticOptimizer(int seed, int length, int tl, int popsize, int offsize, double mutationRate, double deathRate, double delayRate, double delayMean)
        {
            _seed = seed;
        ...
        {
            public Func<int[], double[], double> FitnessFunction { get; set; }
            NewGeneticOptimizer _reftoGO;
            public double Fitness { get { return _fitness; } }
            private double _fitness;
            private int _i;
            private ManualResetEvent _doneEvent;
            public FitnessEvaluationThread(int i, NewGeneticOptimizer reftoGO, ManualResetEvent doneEvent)
            {
                _reftoGO = reftoGO;
                _i = i;
